...
const App = () => {
  const data = [{
    id : 1,
    image : "https://images.pexels.com/photos/38356838/pexels-photo-38356838.jpeg?_gl=1*d8igq1*_ga*MTAyOTgzNjEwMi4xNzg1MjI3OTky*_ga_8JE65Q40S6*czE3ODUyMjc5OTEkbzEkZzEkdDE3ODUyMjgwODgkajMxJGwwJGgw",
    description : "Prime customers that have access to bank credit and are satisfied with the current product.",
    status : "Satisfied",
  },
  {
    id : 2,
    image : "https://images.pexels.com/photos/38153590/pexels-photo-38153590.jpeg?_gl=1*14v8hhm*_ga*MTAyOTgzNjEwMi4xNzg1MjI3OTky*_ga_8JE65Q40S6*czE3ODUyMjc5OTEkbzEkZzEkdDE3ODUyMzE0OTIkajQwJGwwJGgw",
    description : "Prime customers that have access to bank credit and are not satisfied with the current service.",
    status : "Underserved",
  },
  {
    id : 3,
    image : "https://images.pexels.com/photos/37808531/pexels-photo-37808531.jpeg",
    description : "Customers from near-prime and sub-prime segments with no access to bank credit.",
    status : "Underbanked",
  },
];
  return (
    <div className="bg-white m-3 sm:m-6 lg:m-8 xl:m-12 rounded-lg p-4 sm:p-6 lg:p-8 xl:p-12">
      <div className="flex flex-row justify-between gap-3 items-center">
        <button className="bg-black hover:bg-gray-700 transition-all duration-300 cursor-pointer text-white font-medium text-xs md:text-sm py-2 px-4 rounded-full text-nowrap">
          TARGET AUDIENCE
        </button>
